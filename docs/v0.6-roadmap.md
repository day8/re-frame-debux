...
| Item | improvement-plan ref | Status | Commit |
|---|---|---|---|
| Item 10 — `:once` / duplicate-suppression option | §6 item 10 | ✓ shipped | `33225e8` |
| Item 11 — fx-map tracing | §6 item 11 | ✓ shipped as `fx-traced` / `defn-fx-traced` | `bae1b0d` |
| Item 12 — function entry/exit markers (#37) | §6 item 12 | ✓ shipped as `:trace-frames` | `8ba53a8` |
| Item 13 — "Show all" verbosity mode (#36) | §6 item 13 | ✓ shipped as `:verbose` / `:show-all` | `0177254` |
